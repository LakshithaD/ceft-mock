...
public class EfvTlvBuilder {
    ...
    static {
        ...
        tagPropertyMap.put(EftTlvTag.ADDITIONAL_DATA, "additionalData");
    ...
    private static String buildTagLength(EftTlvTag tag, String propertyName, FinancialMessage financialMessage) {
        ...
        String tagValue = financialMessage.getMerchantType() == MerchantType.LPOPP && tag == EftTlvTag.TRANSACTION_CODE
                ? financialMessage.getLPOPPTransactionCode()
                : getTagValue(propertyName, financialMessage);
